@tool
class_name Chest_01 extends Area2D

@export var potential_items: Array[Item_01] = []
...
func create_pickup() -> void:
	...
	var item: Item_01 = potential_items.pick_random()
	var pickup: Pickup_01 = preload("pickup.tscn").instantiate()
	pickup.item = item
	add_child(pickup)
